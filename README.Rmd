...
:point_right: **The processed data are available on our [public-facing dashboard](https://rainorsnowmaps.com/)** :point_left:
...
`datetime: 2025-04-10 12:30:00 UTC`,`lat = 40`,`lon = -105`, `phase = "Snow"`

```{r example load, eval = TRUE, echo = FALSE}
...
```{r metout, eval = TRUE, echo = FALSE}
# Output of 37 variables
