...
def mros_append_daily_data(event, context):
    ...
    try:
        ...
        # input_df = wr.s3.read_csv(INPUT_S3_URI, boto3_session=boto_session)
    ...
    try:
        ...
        # output_df = wr.s3.read_csv(OUTPUT_S3_URI, boto3_session=boto_session)
    ...
    try:
        ...
        # wr.s3.to_csv(output_df, UPDATED_S3_CSV_URI, index = False, boto3_session=boto_session)
